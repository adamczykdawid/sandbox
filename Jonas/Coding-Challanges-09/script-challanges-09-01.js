...
for (let [key, value] of Object.entries(game.scored)) {
  key++;
  const goalScorers = `Goal ${key}:${value}`;
  console.log(goalScorers);
}

//////////CODCHALL 2 ---2
let avgOdd = 0;
const { odds: gameOdds } = game;
console.log(gameOdds);

for (let [key, value] of Object.entries(game.odds)) {
  avgOdd += value;
}
console.log(avgOdd / Object.keys(gameOdds).length);
...
// console.log(gk1, fieldplayers2, fieldplayers1, gk2);
...
// printGoals('Ronaldo', 'Sancho', 'Mata');
