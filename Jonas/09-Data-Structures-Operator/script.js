...
document.querySelector('button').addEventListener('click', function () {
  ...
  const textWorking = text.trim().split('_');
  console.log(textWorking);
  const [firstWord, secondWord] = textWorking;
  const finalSecond = secondWord[0].toUpperCase() + secondWord.slice(1);
  const finalText = firstWord + finalSecond;
